...
filename = "circular_data"; % questo file contiene le informazioni dei vertici
...
ylabel('Perimetro in sezione, A_b/L [m]')
yyaxis right
plot(cumsum(step_vec(1:k-1)), area_, 'bO-')
ylabel('Area in sezione, V_c / L [m^2]')
